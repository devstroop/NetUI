...
using vc.controls.timeline.winform.Properties;
...
namespace vc.controls.timeline.winform
{
	...
	{
		// Token: 0x0600009C RID: 156 RVA: 0x00002E70 File Offset: 0x00001070
		public UCTimeBar()
		{
		...
		// Token: 0x0600009D RID: 157 RVA: 0x00002F1C File Offset: 0x0000111C
		...
		// Token: 0x0600009E RID: 158 RVA: 0x0000301A File Offset: 0x0000121A
		private void Reset()
		{
			this._originPos = 0;
			this._spaceLeft = 0;
			...
			if ((this._option._showUpScale && this._option._showUpScaleValue) || (this._option._showBottomScale && this._option._showBottomScaleValue))
			{
				...
				case TimeUnits.Month:
				{
					...
					if (this._option._showUpScale && this._option._showUpScaleValue)
					{
						...
						{
							g.DrawString(dateTime4.Year.ToString() + "年", this._option._scalcFontBold, this._option._brushScalcString, new PointF((float)(scalePosX - 16), (float)(scalePosY - 15)));
						}
						else
						{
							g.DrawString(dateTime4.Month.ToString() + "月", this._option._scalcFont, this._option._brushScalcString, new PointF((float)(scalePosX - 10), (float)(scalePosY - 15)));
						}
					}
					if (this._option._showBottomScale)
					{
		...
		// Token: 0x060000A8 RID: 168 RVA: 0x000040F0 File Offset: 0x000022F0
		...
		// Token: 0x060000A9 RID: 169 RVA: 0x0000411C File Offset: 0x0000231C
		...
		// Token: 0x060000AA RID: 170 RVA: 0x0000414C File Offset: 0x0000234C
		...
		// Token: 0x060000AB RID: 171 RVA: 0x0000418C File Offset: 0x0000238C
		...
		// Token: 0x060000AD RID: 173 RVA: 0x000042A3 File Offset: 0x000024A3
		...
		// Token: 0x060000AE RID: 174 RVA: 0x000042C8 File Offset: 0x000024C8
		...
		// Token: 0x060000B0 RID: 176 RVA: 0x00004660 File Offset: 0x00002860
		...
		// Token: 0x060000B2 RID: 178 RVA: 0x00004750 File Offset: 0x00002950
		...
		// Token: 0x060000B3 RID: 179 RVA: 0x000047A4 File Offset: 0x000029A4
		...
		// Token: 0x060000B4 RID: 180 RVA: 0x0000480C File Offset: 0x00002A0C
		...
		// Token: 0x060000F0 RID: 240 RVA: 0x00005238 File Offset: 0x00003438
		...
		// Token: 0x060000F1 RID: 241 RVA: 0x000052D8 File Offset: 0x000034D8
		...
		// Token: 0x060000F2 RID: 242 RVA: 0x00005348 File Offset: 0x00003548
		...
		// Token: 0x060000F4 RID: 244 RVA: 0x00005484 File Offset: 0x00003684
		...
		// Token: 0x060000F5 RID: 245 RVA: 0x000054E0 File Offset: 0x000036E0
		...
		// Token: 0x060000F6 RID: 246 RVA: 0x000054F8 File Offset: 0x000036F8
		...
		// Token: 0x060000F7 RID: 247 RVA: 0x0000553E File Offset: 0x0000373E
		...
		public List<TimeSection> GetSectionContainsDateTime(DateTime dt)
		{
			...
			foreach (Channel channel in this.Channels)
			{
				...
				if ((match = <>9__0) == null)
				{
					match = (<>9__0 = ((TimeSection s) => s.DateTimeBegin <= dt && s.DateTimeEnd >= dt));
				}
		...
		public TimeSection GetSection(string guid)
		{
			...
			foreach (Channel channel in this.Channels)
			{
				...
				if ((match = <>9__0) == null)
				{
					match = (<>9__0 = ((TimeSection s) => s.GUID == guid));
				}
		...
		// Token: 0x060000FA RID: 250 RVA: 0x00005694 File Offset: 0x00003894
		public List<TimeSection> GetSections(string guid)
		{
			...
			foreach (Channel channel in this.Channels)
			{
				...
				if ((match = <>9__0) == null)
				{
					match = (<>9__0 = ((TimeSection m) => m.GUID == guid));
				}
